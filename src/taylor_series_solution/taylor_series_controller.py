...
class TaylorSeriesController:
    ...
    def update_view(self, taylor_series_model):
        ...
        ymin = taylor_series_model.get_ymin()
        ymax = taylor_series_model.get_ymax()
        ...
        self.plot_taylor_approximation_function(
            taylor_approximation_function, xmin, xmax, ymin, ymax, number_of_required_coefficients)

    def plot_taylor_approximation_function(self, taylor_approximation_function, xmin, xmax, ymin, ymax, number_of_required_coefficients):
        ...
        self.view.ax.plot(
            x_data, y_data, label=fr"$y = T_{{{number_of_required_coefficients-1}}}f(x)$")

        # Update the plot labels
        self.view.ax.set_title(
            fr"Gráfica de la solución obtenida utilizando series de Taylor con ${number_of_required_coefficients}$ coeficientes", pad=20)
    ...
    def submit(self):
        ...
        taylor_series_model = TaylorSeriesModel(
