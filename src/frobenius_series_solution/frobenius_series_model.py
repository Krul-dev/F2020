...
def generate_frobenius_approximation_function(initial_coefficient_list, number_of_required_coefficients):
    ...
    extented_coefficient_list = generate_coefficient_list(recurrence_relation, adjusted_initial_coefficient_list, number_of_required_coefficients, NUMBER_OF_EXTRA_COEFFICIENTS) 
