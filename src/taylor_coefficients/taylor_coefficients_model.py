...
def generate_taylor_approximation_function(
        taylor_coefficient_function,
        number_of_required_coefficients):
    # Adjust the initial coefficient list
    coefficient_list = [taylor_coefficient_function(
        k) for k in range(number_of_required_coefficients)]
